...
[Advent of Code 2017](https://adventofcode.com/2017) | [Solutions](src/year2017/README.md) |  50⭐ |  25 |  17 |   1
...
2017 |     1 | [22](src/year2017/day22/README.md)
...
2 |   87 µs |   31 µs |   16 µs |    4 ms |  706 µs |  262 µs
3 |  277 µs |  122 µs |  905 µs |   13 ms |   12 ms |   15 µs
4 |   90 ms |    2 ms |  731 µs |   95 µs |   27 ms |  240 µs
5 |    1 ms |  802 ms |   50 ms |    5 ms |   20 µs |   59 µs
6 |    5 ms |   13 µs |  865 µs |    4 ms |    4 ms |  823 µs
7 |    2 ms |   27 ms |  693 µs |   92 µs |  481 µs |    3 ms
8 |   28 µs |  400 µs |  819 µs |  154 µs |   35 µs |  414 µs
9 |   16 ms |  371 µs |   57 µs |   92 ms |    3 ms |  118 µs
10 |   26 ms |  520 µs |   46 µs |  504 µs |    5 ms |   10 µs
11 |    6 ms |   18 ms |    7 ms |  115 ms |    1 ms |  213 ms
12 |  829 µs |  106 ms |    2 ms |  269 µs |    8 ms |   29 µs
13 |  102 ms |   24 µs |   84 ms |    4 ms |    9 ms |    8 µs
14 |  840 µs | 1131 ms |    5 ms |  136 ms |    4 ms |    4 ms
15 |    6 ms |    3 ms |  318 ms |   93 ms |    4 ms |  255 ms
16 |  126 µs |   88 ms |   12 ms |  756 µs |  180 ms |  862 µs
17 |   30 ms |   21 ms |  136 µs |    2 ms |    2 ms |   27 ms
18 |   20 ms |  162 ms |    5 ms |   24 ms |   85 ms |  209 µs
19 |  498 µs |    1 µs |   86 µs |    7 ms |   21 ms |  112 ms
20 |    8 ms |  100 µs |   29 ms |    1 ms |   40 ms |  817 µs
21 |   61 µs |    2 ms |   33 ms |  213 µs |    5 ms |  300 µs
22 |    2 ms |  695 µs |  144 ms |   41 ms |   11 µs |   95 ms
23 |   24 µs |  183 µs |    2 ms |  944 µs |    2 ms |  142 ms
24 |   17 ms |    3 ms |   65 ms |   16 ms |   32 ms |   46 ms
25 |   74 ms |   20 ms |  194 ms |    1 ms |   15 ms |  113 µs

day |    2021 |    2022 |    2023 |    2024 |    2025
------- | ------- | ------- | ------- | ------- | -------
1 |   27 µs |   48 µs |  164 µs |  104 µs |   62 µs
2 |   42 µs |  103 µs |  158 µs |  291 µs |  931 µs
3 |   80 µs |   65 µs |  132 µs |  676 µs |  387 µs
4 |  155 µs |  294 µs |  242 µs |  317 µs |    3 ms
5 |  738 µs |  388 µs |   48 µs |    4 ms |   54 µs
6 |    5 µs |  871 µs |    3 µs |   10 ms |   30 µs
7 |  283 µs |  247 µs |   18 ms |   53 ms |  369 µs
8 |  732 µs |  553 µs |    2 ms |   96 µs |   15 ms
9 |  488 µs |  639 µs |  408 µs |  242 ms |    4 ms
10 |   64 µs |   13 µs |   24 ms |  425 µs |    5 ms
11 |  223 µs |    5 ms |    1 ms |    9 ms |  209 µs
12 |   34 ms |  820 µs |   51 ms |    4 ms |   46 ms
13 |    1 ms |  776 µs |  252 µs |   56 µs |
14 |  607 µs |   10 ms |   49 ms |   20 ms |
15 |   37 ms |   20 µs |  350 µs |    1 ms |
16 |   26 µs |    3 ms |   24 ms |    3 ms |
17 |   94 ms |    1 ms |  155 ms |    6 µs |
18 |    6 ms |    2 ms |   53 µs |  401 µs |
19 |    4 ms |    8 ms |    2 ms |   64 ms |
20 |   97 ms |  100 ms |    3 ms |   28 ms |
21 |    3 ms |  610 µs |    4 ms |  843 µs |
22 |   77 ms |    6 ms |    7 ms |   12 ms |
23 |  228 ms |  150 ms |  199 ms |  129 ms |
24 |   69 ms |   92 ms |  595 µs |  221 µs |
25 |   67 ms |   14 µs |  209 ms |  472 µs |
