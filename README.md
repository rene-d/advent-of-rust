...
3 |  275 µs |  119 µs |  904 µs |   13 ms |   12 ms |   15 µs
4 |   90 ms |    2 ms |  731 µs |   93 µs |   27 ms |  238 µs
5 |    1 ms |  736 ms |   50 ms |    5 ms |   20 µs |   59 µs
6 |    5 ms |   12 µs |  865 µs |    3 ms |    4 ms |  823 µs
7 |    2 ms |   27 ms |  684 µs |   89 µs |  475 µs |    3 ms
8 |   28 µs |  398 µs |  819 µs |  153 µs |   34 µs |  414 µs
9 |   16 ms |  369 µs |   57 µs |   92 ms |    3 ms |  118 µs
10 |   26 ms |  506 µs |   46 µs |  504 µs |    5 ms |   10 µs
11 |    6 ms |   18 ms |    7 ms |  114 ms |    1 ms |  213 ms
12 |  829 µs |  106 ms |    2 ms |  269 µs |    8 ms |   29 µs
13 |  100 ms |   24 µs |   51 ms |    4 ms |    9 ms |    8 µs
14 |  839 µs | 1131 ms |    5 ms |  136 ms |    4 ms |    4 ms
15 |    6 ms |    3 ms |  318 ms |   93 ms |    4 ms |  255 ms
16 |  123 µs |   88 ms |   12 ms |  756 µs |  180 ms |  837 µs
17 |   30 ms |   21 ms |  136 µs |    2 ms |    2 ms |   27 ms
18 |   20 ms |  816 µs |    5 ms |   24 ms |   85 ms |  209 µs
19 |  487 µs |    1 µs |   86 µs |    7 ms |   21 ms |  112 ms
20 |    8 ms |   99 µs |   28 ms |    1 ms |   35 ms |  805 µs
21 |   61 µs |    2 ms |   32 ms |  207 µs |    5 ms |  300 µs
22 |    2 ms |  692 µs |  144 ms |   40 ms |   11 µs |   93 ms
23 |   22 µs |  182 µs |    2 ms |  942 µs |    2 ms |  142 ms
24 |   17 ms |    3 ms |   65 ms |   16 ms |   27 ms |   38 ms
25 |   74 ms |   20 ms |  194 ms |    1 ms |   15 ms |  110 µs

day |    2021 |    2022 |    2023 |    2024 |    2025
------- | ------- | ------- | ------- | ------- | -------
1 |   26 µs |   48 µs |  163 µs |  101 µs |   62 µs
2 |   42 µs |  103 µs |  157 µs |  291 µs |  931 µs
3 |   77 µs |   64 µs |  132 µs |  674 µs |  377 µs
4 |  155 µs |  294 µs |  237 µs |  317 µs |    3 ms
5 |  724 µs |  383 µs |   46 µs |    4 ms |   54 µs
6 |    4 µs |  867 µs |    3 µs |    9 ms |   30 µs
7 |  282 µs |  247 µs |   18 ms |   53 ms |  327 µs
8 |  732 µs |  553 µs |    2 ms |   96 µs |   15 ms
9 |  479 µs |  630 µs |  408 µs |  242 ms |    4 ms
10 |   63 µs |   13 µs |   23 ms |  411 µs |    4 ms
11 |  220 µs |    5 ms |    1 ms |    9 ms |  201 µs
12 |   34 ms |  820 µs |   50 ms |    3 ms |   45 ms
13 |    1 ms |  776 µs |  252 µs |   56 µs |
14 |  607 µs |   10 ms |   49 ms |   19 ms |
15 |   37 ms |   20 µs |  344 µs |    1 ms |
16 |   25 µs |    3 ms |   24 ms |    3 ms |
17 |   94 ms |    1 ms |  154 ms |    6 µs |
18 |    6 ms |    1 ms |   53 µs |  394 µs |
19 |    4 ms |    8 ms |    2 ms |   63 ms |
20 |   97 ms |  100 ms |    3 ms |   27 ms |
21 |    3 ms |  610 µs |    4 ms |  834 µs |
22 |   77 ms |    6 ms |    7 ms |   10 ms |
23 |  228 ms |  138 ms |  199 ms |  127 ms |
24 |   69 ms |   92 ms |  558 µs |  215 µs |
